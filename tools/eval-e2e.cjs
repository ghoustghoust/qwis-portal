...
const SRC = {
  ...
  readingTab: 'api/[...slug].js:1059',   // ['all','favorited','read']（B26 拆首屏后又下移；G5 专抓这种漂移）
  readingType: 'api/[...slug].js:1060',  // ['all','article','video','podcast']
  ...
  pageSizeReading: 'api/[...slug].js:1062',
