...
cloudTest('R1 reading type=video 不泄漏文章（快路径 type 检查）', async () => {
...
cloudTest('R2 reading q=AI 搜索有结果（OR 拆分分支参数完整绑定）', async () => {
...
cloudTest('R5 OPML 导出：结构/转义/分组嵌套', async () => {
