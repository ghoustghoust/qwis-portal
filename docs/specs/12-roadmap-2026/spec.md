...
### P1-2 AI 基础设施 —— ✅ 已完成（2026-09-12，16-ai-infra）
...
### P1-3b 翻译多轮管线（并入 P1-3 实施） —— ✅ 已完成（17-translate，2026-09-12）
- 筛信息 → 初翻 → 词库对照 → 精翻（2-3 轮）；InfoQ（源 id 145，已在库）作为术语库优质语料

### P1-4 早报体系 v2（原"AI 日报 v2"扩展，2026-09-12 用户确认三级产品）
...
### P1-5 我的早报（新增，AI 晚间整理早 9:00 送达，无破圈）
- 基于用户订阅子集；UI 参考 archive/样图/new（导语/分层/卡片结构/六维评分展示）
### P1-6 精选周刊（新增，本周必看 20 条，无破圈，圈内必看：行业大变化/大影响/教学/新理解）
### P1-7 阅读体验：全文阅读 + 中英切换 + 手动翻译 + 今日主题导语 + 头条 AI 总结
