...
> 🗄 已归档 2026-09-11：通用助手模板。现行替代：根目录新 AGENTS.md。

> ⚠️ **先读 ARCHITECTURE.md**——系统全景、数据通路、凭据位置、已知坑、协作规则都在那里。本文档是通用工程规约,ARCHITECTURE.md 是项目专用上下文。
...
`C:\Users\17619\.openclaw-autoclaw\skills/<skill-name>/SKILL.md`
