...
> ⚠️ 已归档（2026-09-15）：Phase 1-5 重构早已完成，仅留作历史参照。当前架构以 `ARCHITECTURE.md` + `docs/CLOUD_PIPELINE_GUIDE.md` 为准。


> [历史文档] 记录 Phase 1-5 深度架构重构的文件拆分映射表 + import 路径变更。
> 日期: 2026-09-05（2026-09-09 文档清洗时标注为历史文档）
