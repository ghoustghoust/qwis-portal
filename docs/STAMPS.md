...
**统计**：底层文档 一致 8 · 待判 10 · 头部超前 0 · 缺头注 0　|　不要求头注 195 份　|　工作区未提交 1 份　|　总计 213 份
...
| docs/eval/2026-09-24-prescreen-step1.md | 2026-09-24 | 不要求头注 ⚠ | `48af997` 2026-09-24 21:00 feat(夜间预算按峰值重排 + 两段耗时/尝试数落库 + 配额键可写): 用户裁定"时间长一点都可以,各边界留缓冲"<br>`3ee95c9` 2026-09-24 18:47 docs(POST 副作用边界): 关键词版 id=69 未顶掉读者所见的 AI 版 id=68,代价只是历史多一行 |
