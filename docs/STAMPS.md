...
**统计**：底层文档 一致 8 · 待判 10 · 头部超前 0 · 缺头注 0　|　不要求头注 194 份　|　工作区未提交 6 份　|　总计 212 份
...
| docs/FEATURE_MATRIX.md | 2026-09-24 | 一致 ⚠ | `76b72f3` 2026-09-24 17:36 test(读层内联生成器执行锁 I1~I3): mock req/res 跑整个 catch-all handler,file: 临时库,零生产写<br>`6833df4` 2026-09-24 17:20 docs(H25 核销 + 读层生成器活体实测): 抬池后 id=69 覆盖 202→313,POST /api/daily-generate 200/33s/零模型调用<br>`e468b3b` 2026-09-24 17:10 feat(H25 抬宽池读 2000→6000): 级3 的真天花板不是 cap 而是候选宽池读,单一取值收进 lib/prescreen |
...
| docs/ISSUES.md | 2026-09-23 | 待判 ⚠ | `6833df4` 2026-09-24 17:20 docs(H25 核销 + 读层生成器活体实测): 抬池后 id=69 覆盖 202→313,POST /api/daily-generate 200/33s/零模型调用<br>`e468b3b` 2026-09-24 17:10 feat(H25 抬宽池读 2000→6000): 级3 的真天花板不是 cap 而是候选宽池读,单一取值收进 lib/prescreen<br>`b1e3f71` 2026-09-24 15:59 docs(级3 第一期生产读数到手·id=68): 两处原预估被证伪,新登记 H25 |
...
| docs/changes/2026-09-23-rss-pipeline-discussion-handoff.md | — | 不要求头注 ⚠ | `3ee95c9` 2026-09-24 18:47 docs(POST 副作用边界): 关键词版 id=69 未顶掉读者所见的 AI 版 id=68,代价只是历史多一行<br>`6833df4` 2026-09-24 17:20 docs(H25 核销 + 读层生成器活体实测): 抬池后 id=69 覆盖 202→313,POST /api/daily-generate 200/33s/零模型调用 |
...
| docs/eval/2026-09-24-prescreen-step1.md | 2026-09-24 | 不要求头注 ⚠ | `3ee95c9` 2026-09-24 18:47 docs(POST 副作用边界): 关键词版 id=69 未顶掉读者所见的 AI 版 id=68,代价只是历史多一行<br>`f79d152` 2026-09-24 17:44 docs(POST 副作用边界): 关键词版 id=69 未顶掉读者所见的 AI 版 id=68,代价只是历史多一行 |
...
| docs/specs/44-prescreen-tier/spec.md | 2026-09-24 | 不要求头注 ⚠ | `6833df4` 2026-09-24 17:20 docs(H25 核销 + 读层生成器活体实测): 抬池后 id=69 覆盖 202→313,POST /api/daily-generate 200/33s/零模型调用<br>`e468b3b` 2026-09-24 17:10 feat(H25 抬宽池读 2000→6000): 级3 的真天花板不是 cap 而是候选宽池读,单一取值收进 lib/prescreen |
