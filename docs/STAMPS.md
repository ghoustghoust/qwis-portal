...
**统计**：底层文档 一致 8 · 待判 10 · 头部超前 0 · 缺头注 0　|　不要求头注 196 份　|　工作区未提交 1 份　|　总计 214 份
...
| docs/specs/44-prescreen-tier/spec.md | 2026-09-24 | 不要求头注 ⚠ | `cc6f372` 2026-09-24 22:36 docs(行为正样本回测·判据清单改判): 形态类规则误砍 0/246 该上,长度类规则误砍 40.2%/9.8% 直接否决<br>`48af997` 2026-09-24 21:00 feat(夜间预算按峰值重排 + 两段耗时/尝试数落库 + 配额键可写): 用户裁定"时间长一点都可以,各边界留缓冲" |
