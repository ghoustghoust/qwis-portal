...
**统计**：底层文档 一致 10 · 待判 6 · 头部超前 2 · 缺头注 0　|　不要求头注 231 份　|　工作区未提交 15 份　|　总计 249 份
...
| docs/DOC_GOVERNANCE.md | 2026-09-20 | 一致 ⚠ | `29c821f` 2026-09-20 17:58 docs(§4.1 精炼落地): 46 行长文压成"问题+定性+去处"，原文逐字照档且可反查<br>`c183413` 2026-09-20 17:00 docs(§4.1 补全定义): 洁净=精炼+去冗+归档；INDEX 登记两份新归档件（只提交我自己的 hunk）<br>`1856991` 2026-09-20 16:05 docs(洁净规则): §4.1 新增精炼度判据——洁净的终点是"不可再被误解的最短"，并给出硬性停下信号 |
| docs/EVAL_GUIDE.md | 2026-09-19 | 待判 | `5695874` 2026-09-20 23:08 fix(#65 之后第 3 条)+test(B102): 删除/保留谓词收进 lib/retention.js 一份，本地不再删内容<br>`6e0c5c6` 2026-09-20 22:02 fix(eval)+test(#65): B106 收口 —— 取证工具不再把"没跑到"判成"锁假了"，清单参数不再静默截断<br>`9cabd97` 2026-09-20 21:37 test(eval): B104 收口 —— 坑 #62/#63/#64 各配真锁，并修掉判据自己的两处恒真 |
| docs/FEATURE_MATRIX.md | 2026-09-20 | 一致 ⚠ | `5695874` 2026-09-20 23:08 fix(#65 之后第 3 条)+test(B102): 删除/保留谓词收进 lib/retention.js 一份，本地不再删内容<br>`6e0c5c6` 2026-09-20 22:02 fix(eval)+test(#65): B106 收口 —— 取证工具不再把"没跑到"判成"锁假了"，清单参数不再静默截断<br>`9cabd97` 2026-09-20 21:37 test(eval): B104 收口 —— 坑 #62/#63/#64 各配真锁，并修掉判据自己的两处恒真 |
...
| docs/ISSUES.md | 2026-09-21 | 一致 ⚠ | `2e3de79` 2026-09-21 00:23 fix(weekly)+test(B121): 周刊骨架缺失如实进状态，期号按内容窗口定，杂志层退避重试一次<br>`4608b3a` 2026-09-20 23:40 docs(换库后遗症 B119①): 日报候选池放开并落一手对账 —— 26h 窗口 82 条/9 源 → 1,939 条/308 源<br>`5695874` 2026-09-20 23:08 fix(#65 之后第 3 条)+test(B102): 删除/保留谓词收进 lib/retention.js 一份，本地不再删内容 |
...
| docs/RUNBOOK.md | 2026-09-20 | 一致 ⚠ | `5695874` 2026-09-20 23:08 fix(#65 之后第 3 条)+test(B102): 删除/保留谓词收进 lib/retention.js 一份，本地不再删内容<br>`2a13808` 2026-09-20 16:32 docs(B120 收口 + B123): runner 侧证据按坑 #68 补齐，页头写死"关键词规则排序"另立一条<br>`e856f6c` 2026-09-20 12:17 docs(换库收口): 登记 B118/B119 + 本轮交付链十一条状态，并把"配额是墙钟事件"落成不变量 19 与坑 #D4 |
...
| docs/specs/43-collect-retention-safety/spec.md | — | 不要求头注 ⚠ | `4205170` 2026-09-20 08:09 docs(第6轮只读复核): 测试侧写入面全量清点——生产数据从未被测试写过，但 3 份仍绑生产（B117）<br>`e9665ce` 2026-09-20 07:26 docs(自洽): 「未 push 提交」不再写死编号与条数，改成取法（git rev-list / git log） |
