...
| docs/archive/debugging/2026-09-21-issues-round2-closed.md | — | 不要求头注 ⚠ | `9d6346b` 2026-09-21 22:58 docs(round2 归档件): 重复节号 §九 拆出 §十（阻塞级重排改写行）<br>`7210851` 2026-09-21 22:58 docs(ISSUES 待开发队列按阻塞级重排): P0 挡验收链/数据安全(B105→B131→⑥b→B132) → P1 口径(B29/B69/B23+B24/B133) → P2 体验(B73/B8/B10/B123/B17/B18/B21+H13) → P3 长尾(B87/B70/B86);审查列标注 ✅已放行/⏳待点头,用户逐条审;重排改写行原文已无损收进 round2 归档件 §九 |
