...
| docs/ISSUES.md | 2026-09-21 | 一致 ⚠ | `24e76bf` 2026-09-21 07:15 feat(B111/39-6)+test(PR1~PR7)+feat(W20)+坑#71: 翻译 prompt 收成 lib/ai-prompts.js 一份，三种键名归一<br>`467d10c` 2026-09-21 06:43 fix(B112)+test(Q1~Q5)+坑#70: 日报档位字段写入侧统一为整数常量，判据并进 W14<br>`aa1697c` 2026-09-21 06:26 docs(B111 现状实测): 翻译链路上其实是 5 份 prompt 文本 + 3 个互不相通的 settings 键名 |
