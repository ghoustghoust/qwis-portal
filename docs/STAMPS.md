...
| docs/FEATURE_MATRIX.md | 2026-09-24 | 一致 ⚠ | `e468b3b` 2026-09-24 17:10 feat(H25 抬宽池读 2000→6000): 级3 的真天花板不是 cap 而是候选宽池读,单一取值收进 lib/prescreen<br>`b1e3f71` 2026-09-24 15:59 docs(级3 第一期生产读数到手·id=68): 两处原预估被证伪,新登记 H25<br>`f0affdb` 2026-09-24 15:00 docs(FEATURE_MATRIX 补级3能力行): §1.2 候选层每源预配额（四处部署面接线/本地端按裁定A不接/读数落 stats.prescreen）+ §1.5 头注与条数同步 |
...
| docs/ISSUES.md | 2026-09-23 | 待判 ⚠ | `e468b3b` 2026-09-24 17:10 feat(H25 抬宽池读 2000→6000): 级3 的真天花板不是 cap 而是候选宽池读,单一取值收进 lib/prescreen<br>`b1e3f71` 2026-09-24 15:59 docs(级3 第一期生产读数到手·id=68): 两处原预估被证伪,新登记 H25<br>`c913ef4` 2026-09-24 15:08 docs(ISSUES H24): ai_failed 冷却键单一全局位(120min)——初筛异常与通道全挂互相吞，09-23 两期同满足条件窗口内只落一条；且 detail 不存正文事后无法分辨子因 |
...
| docs/specs/44-prescreen-tier/spec.md | 2026-09-24 | 不要求头注 ⚠ | `e468b3b` 2026-09-24 17:10 feat(H25 抬宽池读 2000→6000): 级3 的真天花板不是 cap 而是候选宽池读,单一取值收进 lib/prescreen<br>`b1e3f71` 2026-09-24 15:59 docs(级3 第一期生产读数到手·id=68): 两处原预估被证伪,新登记 H25 |
