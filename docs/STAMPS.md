...
**统计**：底层文档 一致 8 · 待判 10 · 头部超前 0 · 缺头注 0　|　不要求头注 197 份　|　工作区未提交 8 份　|　总计 215 份
...
| docs/CLOUD_PIPELINE_GUIDE.md | 2026-09-23 | 待判 ⚠ | `00fa95a` 2026-09-24 23:23 docs(H29·什么在大量读 Turso)：删除闸从 09-22 起恒挡→库只涨不删；体积不是腹泻源撑的<br>`48af997` 2026-09-24 21:00 feat(夜间预算按峰值重排 + 两段耗时/尝试数落库 + 配额键可写): 用户裁定"时间长一点都可以,各边界留缓冲"<br>`e468b3b` 2026-09-24 17:10 feat(H25 抬宽池读 2000→6000): 级3 的真天花板不是 cap 而是候选宽池读,单一取值收进 lib/prescreen |
...
| docs/FEATURE_MATRIX.md | 2026-09-24 | 一致 ⚠ | `00fa95a` 2026-09-24 23:23 docs(H29·什么在大量读 Turso)：删除闸从 09-22 起恒挡→库只涨不删；体积不是腹泻源撑的<br>`eb396ba` 2026-09-24 22:24 docs(H28·配置可写性系统清点): ai.minIntervalMs 与 ai.filterThreshold 部署面零写点,gap 议题在云端目前调不动<br>`7c47d93` 2026-09-24 22:01 feat(零额度初筛实验脚手架): 三臂留一法 + 分歧带清单,标注一回来就一条命令出结论 |
...
| docs/ISSUES.md | 2026-09-23 | 待判 ⚠ | `00fa95a` 2026-09-24 23:23 docs(H29·什么在大量读 Turso)：删除闸从 09-22 起恒挡→库只涨不删；体积不是腹泻源撑的<br>`eb396ba` 2026-09-24 22:24 docs(H28·配置可写性系统清点): ai.minIntervalMs 与 ai.filterThreshold 部署面零写点,gap 议题在云端目前调不动<br>`7d23658` 2026-09-24 22:14 docs(H27 成因量化 + 配额键读侧生产实测): schedule 投递率≈12%,AI 批与 collect 挤同一队列=病根 |
...
| docs/changes/2026-09-23-rss-pipeline-discussion-handoff.md | — | 不要求头注 ⚠ | `00fa95a` 2026-09-24 23:23 docs(H29·什么在大量读 Turso)：删除闸从 09-22 起恒挡→库只涨不删；体积不是腹泻源撑的<br>`48af997` 2026-09-24 21:00 feat(夜间预算按峰值重排 + 两段耗时/尝试数落库 + 配额键可写): 用户裁定"时间长一点都可以,各边界留缓冲" |
...
| docs/eval/2026-09-24-prescreen-labels.md | — | 不要求头注 ⚠ | `cc6f372` 2026-09-24 22:36 docs(行为正样本回测·判据清单改判): 形态类规则误砍 0/246 该上,长度类规则误砍 40.2%/9.8% 直接否决<br>`7c47d93` 2026-09-24 22:01 feat(零额度初筛实验脚手架): 三臂留一法 + 分歧带清单,标注一回来就一条命令出结论 |
...
| docs/eval/2026-09-24-source-diagnosis.md | — | 不要求头注 | `eb396ba` 2026-09-24 22:24 docs(H28·配置可写性系统清点): ai.minIntervalMs 与 ai.filterThreshold 部署面零写点,gap 议题在云端目前调不动<br>`7d23658` 2026-09-24 22:14 docs(H27 成因量化 + 配额键读侧生产实测): schedule 投递率≈12%,AI 批与 collect 挤同一队列=病根 |
| docs/eval/2026-09-24-turso-read-amp.md | — | 不要求头注 ⚠ | `00fa95a` 2026-09-24 23:23 docs(H29·什么在大量读 Turso)：删除闸从 09-22 起恒挡→库只涨不删；体积不是腹泻源撑的 |
...
| docs/specs/44-prescreen-tier/spec.md | 2026-09-24 | 不要求头注 ⚠ | `78c41c4` 2026-09-24 22:44 docs(lint 自查回补): doc-lint:ignore 只在同行生效,上一条把标记留在了跨行条目末尾<br>`cc6f372` 2026-09-24 22:36 docs(行为正样本回测·判据清单改判): 形态类规则误砍 0/246 该上,长度类规则误砍 40.2%/9.8% 直接否决 |
