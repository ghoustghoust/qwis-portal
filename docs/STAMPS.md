...
**统计**：底层文档 一致 6 · 待判 10 · 头部超前 2 · 缺头注 0　|　不要求头注 236 份　|　工作区未提交 15 份　|　总计 254 份
...
| docs/FEATURE_MATRIX.md | 2026-09-20 | 待判 ⚠ | `24e76bf` 2026-09-21 07:15 feat(B111/39-6)+test(PR1~PR7)+feat(W20)+坑#71: 翻译 prompt 收成 lib/ai-prompts.js 一份，三种键名归一<br>`467d10c` 2026-09-21 06:43 fix(B112)+test(Q1~Q5)+坑#70: 日报档位字段写入侧统一为整数常量，判据并进 W14<br>`6c9a2c7` 2026-09-21 06:20 feat(B109/B45)+test(V1~V7)+feat(W19): 报警事件表收成 lib/alert-events.js 一份，云端后台四个假开关拔掉 |
...
| docs/ISSUES.md | 2026-09-21 | 一致 ⚠ | `23d7791` 2026-09-21 07:17 docs(B111 验收入账): F2P 改前红 7/7 → 改后 7/7 绿 + 线上 commit 已等于 origin/main<br>`24e76bf` 2026-09-21 07:15 feat(B111/39-6)+test(PR1~PR7)+feat(W20)+坑#71: 翻译 prompt 收成 lib/ai-prompts.js 一份，三种键名归一<br>`467d10c` 2026-09-21 06:43 fix(B112)+test(Q1~Q5)+坑#70: 日报档位字段写入侧统一为整数常量，判据并进 W14 |
