...
**统计**：底层文档 一致 3 · 待判 7 · 头部超前 8 · 缺头注 0　|　不要求头注 190 份　|　工作区未提交 74 份　|　总计 208 份
...
| ARCHITECTURE.md | 2026-09-23 | 头部超前 ⚠ | `2a13808` 2026-09-20 16:32 docs(B120 收口 + B123): runner 侧证据按坑 #68 补齐，页头写死"关键词规则排序"另立一条<br>`530a5f4` 2026-09-20 07:14 docs(specs+落账): 36/37/39/40 四域小 spec 补齐（26 份）+ 叫停轮的只读取证全部落档，未 push<br>`8cb88c4` 2026-09-19 20:24 fix(web): B85 修法补全——设了上界的列还要可收缩，否则窄档裁掉行尾（自打回归） |
