...
**统计**：底层文档 一致 7 · 待判 11 · 头部超前 0 · 缺头注 0　|　不要求头注 198 份　|　工作区未提交 2 份　|　总计 216 份
...
| docs/FEATURE_MATRIX.md | 2026-09-24 | 待判 | `a88c665` 2026-09-25 04:31 docs(第五轮复审核销): "8% 触发率"是无效分母，按点位算 AI 批 96% 在跑；导语第一条真归因恰恰是 ai_failed<br>`8623ede` 2026-09-25 03:44 fix(门禁红核销): 97da7a4 带着 doc-lint 1 错就推了 —— 表格单元里的裸 \|\| 把行撑成 6 格<br>`97da7a4` 2026-09-25 03:43 docs(H32 自我更正): 起名出口从一条改成四条、回放读数降格为下界（自己复核传参后发现的） |
...
| docs/ISSUES.md | 2026-09-23 | 待判 ⚠ | `a88c665` 2026-09-25 04:31 docs(第五轮复审核销): "8% 触发率"是无效分母，按点位算 AI 批 96% 在跑；导语第一条真归因恰恰是 ai_failed<br>`8623ede` 2026-09-25 03:44 fix(门禁红核销): 97da7a4 带着 doc-lint 1 错就推了 —— 表格单元里的裸 \|\| 把行撑成 6 格<br>`97da7a4` 2026-09-25 03:43 docs(H32 自我更正): 起名出口从一条改成四条、回放读数降格为下界（自己复核传参后发现的） |
...
| docs/eval/2026-09-24-turso-read-amp.md | — | 不要求头注 ⚠ | `a88c665` 2026-09-25 04:31 docs(第五轮复审核销): "8% 触发率"是无效分母，按点位算 AI 批 96% 在跑；导语第一条真归因恰恰是 ai_failed<br>`e11bb81` 2026-09-25 03:53 docs(交付链自查): 记下 97da7a4 那格红——看见门禁输出里的 1 错还继续串 push，是判断问题不是工具问题 |
