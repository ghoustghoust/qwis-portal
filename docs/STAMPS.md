...
| docs/ISSUES.md | 2026-09-23 | 待判 | `c913ef4` 2026-09-24 15:08 docs(ISSUES H24): ai_failed 冷却键单一全局位(120min)——初筛异常与通道全挂互相吞，09-23 两期同满足条件窗口内只落一条；且 detail 不存正文事后无法分辨子因<br>`f81bd6e` 2026-09-24 14:58 docs(ISSUES H23 登记): runDaily 裸报告 candidates 是门槛后口径且从不写 gateDropped（破不变量12，非本轮引入，故意不在步1 修以免污染归因）<br>`d2eefda` 2026-09-24 14:24 docs(步1 收口·四处读数更正): 交接文档快照 / ISSUES H19~H22 / 不变量20 / spec23 L4 作废标注 |
