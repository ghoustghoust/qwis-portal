...
**统计**：底层文档 一致 8 · 待判 10 · 头部超前 0 · 缺头注 0　|　不要求头注 196 份　|　工作区未提交 2 份　|　总计 214 份
...
| docs/FEATURE_MATRIX.md | 2026-09-24 | 一致 ⚠ | `b501b16` 2026-09-24 21:51 docs(H27·AI 早报自动触发未兑现): 晚间主批近 8 次 schedule 全 skipped,现存 AI 行靠人工 dispatch 维持<br>`e3162aa` 2026-09-24 21:29 docs(源侧细查底稿 + 自我推翻一条建议): 336 个不产出的源是四种不同的病;90天归档只占全库正文 7.8%<br>`48af997` 2026-09-24 21:00 feat(夜间预算按峰值重排 + 两段耗时/尝试数落库 + 配额键可写): 用户裁定"时间长一点都可以,各边界留缓冲" |
...
| docs/eval/2026-09-24-prescreen-labels.md | — | 不要求头注 ⚠ | `48af997` 2026-09-24 21:00 feat(夜间预算按峰值重排 + 两段耗时/尝试数落库 + 配额键可写): 用户裁定"时间长一点都可以,各边界留缓冲" |
