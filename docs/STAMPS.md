...
| docs/ISSUES.md | 2026-09-21 | 待判 | `ae77d6d` 2026-09-22 22:58 docs(ISSUES 终态对齐): 删 B17/BL3 两条已交付残留行,速览改成真值(队列全清/AGNES 已轮换/你裁定暂缓批),🔴 段改为『队列已全清+新登记口』<br>`d966499` 2026-09-22 22:56 chore(B119③ 收尾,用户裁定): 删除 25 个全库无源的休眠 wemp 源行(备份已全量留存); 孤儿文章读层 JOIN 自然隐藏; 公众号覆盖定格 40 个<br>`25aa5fe` 2026-09-22 22:39 feat(B119③ 公众号源修复): 实测排除公共桥/直抓/搜狗三路后,走公共 wechat2rss 目录源——恢复 40/65(33 本有 bestblogs.dev 现役源,7 接线 xlab 公共目录); 剩 25 个无源的停用标 retired 不再空转自增 fail_count; 写前全量备份 wemp 源表 |
...
| docs/archive/debugging/2026-09-21-issues-round2-closed.md | — | 不要求头注 | `ae77d6d` 2026-09-22 22:58 docs(ISSUES 终态对齐): 删 B17/BL3 两条已交付残留行,速览改成真值(队列全清/AGNES 已轮换/你裁定暂缓批),🔴 段改为『队列已全清+新登记口』<br>`d966499` 2026-09-22 22:56 chore(B119③ 收尾,用户裁定): 删除 25 个全库无源的休眠 wemp 源行(备份已全量留存); 孤儿文章读层 JOIN 自然隐藏; 公众号覆盖定格 40 个 |
