...
**统计**：底层文档 一致 6 · 待判 10 · 头部超前 2 · 缺头注 0　|　不要求头注 235 份　|　工作区未提交 18 份　|　总计 253 份
...
| docs/ISSUES.md | 2026-09-21 | 一致 ⚠ | `aa1697c` 2026-09-21 06:26 docs(B111 现状实测): 翻译链路上其实是 5 份 prompt 文本 + 3 个互不相通的 settings 键名<br>`4a52576` 2026-09-21 06:22 docs(B109 验收入账): 线上 /api/alerts/config 读数 + F2P 证据（V1~V7 改前红 7/7）<br>`6c9a2c7` 2026-09-21 06:20 feat(B109/B45)+test(V1~V7)+feat(W19): 报警事件表收成 lib/alert-events.js 一份，云端后台四个假开关拔掉 |
