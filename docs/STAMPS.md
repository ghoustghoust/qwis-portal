...
| docs/ISSUES.md | 2026-09-21 | 待判 ⚠ | `718c7a1` 2026-09-22 11:35 docs(B73 核销入账): ISSUES 出队,线上实测读数与并行化+批量化的处置记进归档件<br>`b3d5552` 2026-09-22 11:15 fix(B10/P2-3,生产写): 线上字面键 daily.columns 从回声文案回写为 lib/daily-columns.js#DEFAULT_COLUMNS(备份 docs/eval/b10-daily-columns-backup.json + 写后回读逐条一致); 可见面等下一批日报复验,挪观察段<br>`c814b9b` 2026-09-22 11:11 fix(B123/P2-4)+test(DH1/DH2): 早报页头排序文案读 stats.schemaVersion(AI 策展/关键词两档)+degraded 标记,不再无条件写「关键词规则排序」 |
...
| docs/archive/debugging/2026-09-21-issues-round2-closed.md | — | 不要求头注 ⚠ | `718c7a1` 2026-09-22 11:35 docs(B73 核销入账): ISSUES 出队,线上实测读数与并行化+批量化的处置记进归档件<br>`b3d5552` 2026-09-22 11:15 fix(B10/P2-3,生产写): 线上字面键 daily.columns 从回声文案回写为 lib/daily-columns.js#DEFAULT_COLUMNS(备份 docs/eval/b10-daily-columns-backup.json + 写后回读逐条一致); 可见面等下一批日报复验,挪观察段 |
