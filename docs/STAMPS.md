...
| docs/archive/debugging/2026-09-21-issues-round2-closed.md | — | 不要求头注 ⚠ | `e213327` 2026-09-22 22:16 docs(B122 核销+三条裁定落档): AGNES key 已三处同步轮换并验证(直连 200,部署 da515be); B118/B125/B119②/B80 按你 09-22 裁定标暂缓; B119③ 公众号源实测结论落档<br>`917d8f0` 2026-09-22 19:17 feat(B21+H13/P2-7)+test(HA1~HA5): 我的早报期号归档(同日原地替换/新日 max+1/封顶30/空态不占号) + /api/mybrief/archive 公开端点 + 页头第N期与往期列表; 日报期号按北京日去重读时算,页头带期号; 本期索引查实已有(吸顶 pill 导航) |
