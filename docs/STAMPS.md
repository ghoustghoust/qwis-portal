...
| docs/changes/2026-09-23-rss-pipeline-discussion-handoff.md | — | 不要求头注 ⚠ | `a228da1` 2026-09-24 16:25 docs(读层 HTTP 实测补做·收口链最后一步): /api/meta commit==origin/main,/api/daily 透 stats.prescreen 与直读库逐字段一致<br>`b1e3f71` 2026-09-24 15:59 docs(级3 第一期生产读数到手·id=68): 两处原预估被证伪,新登记 H25 |
...
| docs/eval/2026-09-24-prescreen-step1.md | 2026-09-24 | 不要求头注 ⚠ | `a228da1` 2026-09-24 16:25 docs(读层 HTTP 实测补做·收口链最后一步): /api/meta commit==origin/main,/api/daily 透 stats.prescreen 与直读库逐字段一致<br>`930272e` 2026-09-24 16:11 docs(读层实测记次级证据): 六端口复测仍不通,改记 GitHub 侧 Vercel 部署证据并划清它只覆盖哪一半 |
