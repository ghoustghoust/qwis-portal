...
**统计**：底层文档 一致 7 · 待判 11 · 头部超前 0 · 缺头注 0　|　不要求头注 197 份　|　工作区未提交 3 份　|　总计 215 份
...
| docs/FEATURE_MATRIX.md | 2026-09-24 | 待判 ⚠ | `05fd6b8` 2026-09-25 00:06 feat(三臂行为回测给出"是否采用"的数) + 独立审查推翻本轮 3 条说法后逐条改写<br>`00fa95a` 2026-09-24 23:23 docs(H29·什么在大量读 Turso)：删除闸从 09-22 起恒挡→库只涨不删；体积不是腹泻源撑的<br>`eb396ba` 2026-09-24 22:24 docs(H28·配置可写性系统清点): ai.minIntervalMs 与 ai.filterThreshold 部署面零写点,gap 议题在云端目前调不动 |
...
| docs/ISSUES.md | 2026-09-23 | 待判 ⚠ | `05fd6b8` 2026-09-25 00:06 feat(三臂行为回测给出"是否采用"的数) + 独立审查推翻本轮 3 条说法后逐条改写<br>`00fa95a` 2026-09-24 23:23 docs(H29·什么在大量读 Turso)：删除闸从 09-22 起恒挡→库只涨不删；体积不是腹泻源撑的<br>`eb396ba` 2026-09-24 22:24 docs(H28·配置可写性系统清点): ai.minIntervalMs 与 ai.filterThreshold 部署面零写点,gap 议题在云端目前调不动 |
...
| docs/changes/2026-09-23-rss-pipeline-discussion-handoff.md | — | 不要求头注 | `05fd6b8` 2026-09-25 00:06 feat(三臂行为回测给出"是否采用"的数) + 独立审查推翻本轮 3 条说法后逐条改写<br>`00fa95a` 2026-09-24 23:23 docs(H29·什么在大量读 Turso)：删除闸从 09-22 起恒挡→库只涨不删；体积不是腹泻源撑的 |
...
| docs/eval/2026-09-24-turso-read-amp.md | — | 不要求头注 ⚠ | `05fd6b8` 2026-09-25 00:06 feat(三臂行为回测给出"是否采用"的数) + 独立审查推翻本轮 3 条说法后逐条改写<br>`00fa95a` 2026-09-24 23:23 docs(H29·什么在大量读 Turso)：删除闸从 09-22 起恒挡→库只涨不删；体积不是腹泻源撑的 |
