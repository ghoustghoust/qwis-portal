...
**统计**：底层文档 一致 8 · 待判 8 · 头部超前 2 · 缺头注 0　|　不要求头注 234 份　|　工作区未提交 18 份　|　总计 252 份
...
| docs/EVAL_GUIDE.md | 2026-09-19 | 待判 ⚠ | `e49c54d` 2026-09-21 02:28 test(B117)+feat(W23): 测试侧写方法必须指隔离库 —— 两份打生产的写用例搬进本地 libsql 文件库<br>`5695874` 2026-09-20 23:08 fix(#65 之后第 3 条)+test(B102): 删除/保留谓词收进 lib/retention.js 一份，本地不再删内容<br>`6e0c5c6` 2026-09-20 22:02 fix(eval)+test(#65): B106 收口 —— 取证工具不再把"没跑到"判成"锁假了"，清单参数不再静默截断 |
| docs/FEATURE_MATRIX.md | 2026-09-20 | 待判 ⚠ | `e49c54d` 2026-09-21 02:28 test(B117)+feat(W23): 测试侧写方法必须指隔离库 —— 两份打生产的写用例搬进本地 libsql 文件库<br>`138b1c7` 2026-09-21 01:53 feat(B103/D3)+test(D1~D10): 内容级转储与删除前置闸 —— 云端第一次有"回得来"的底牌<br>`5695874` 2026-09-20 23:08 fix(#65 之后第 3 条)+test(B102): 删除/保留谓词收进 lib/retention.js 一份，本地不再删内容 |
...
| docs/ISSUES.md | 2026-09-21 | 一致 ⚠ | `e49c54d` 2026-09-21 02:28 test(B117)+feat(W23): 测试侧写方法必须指隔离库 —— 两份打生产的写用例搬进本地 libsql 文件库<br>`16a957d` 2026-09-21 01:56 docs(B101 拦一下)+docs(BL10 复核): 待删量按现役库重算是 50,636 条（84.6%），不是旧库那 10,733<br>`138b1c7` 2026-09-21 01:53 feat(B103/D3)+test(D1~D10): 内容级转储与删除前置闸 —— 云端第一次有"回得来"的底牌 |
