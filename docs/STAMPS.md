...
| docs/FEATURE_MATRIX.md | 2026-09-24 | 一致 | `eb396ba` 2026-09-24 22:24 docs(H28·配置可写性系统清点): ai.minIntervalMs 与 ai.filterThreshold 部署面零写点,gap 议题在云端目前调不动<br>`7c47d93` 2026-09-24 22:01 feat(零额度初筛实验脚手架): 三臂留一法 + 分歧带清单,标注一回来就一条命令出结论<br>`b501b16` 2026-09-24 21:51 docs(H27·AI 早报自动触发未兑现): 晚间主批近 8 次 schedule 全 skipped,现存 AI 行靠人工 dispatch 维持 |
...
| docs/ISSUES.md | 2026-09-23 | 待判 | `eb396ba` 2026-09-24 22:24 docs(H28·配置可写性系统清点): ai.minIntervalMs 与 ai.filterThreshold 部署面零写点,gap 议题在云端目前调不动<br>`7d23658` 2026-09-24 22:14 docs(H27 成因量化 + 配额键读侧生产实测): schedule 投递率≈12%,AI 批与 collect 挤同一队列=病根<br>`b501b16` 2026-09-24 21:51 docs(H27·AI 早报自动触发未兑现): 晚间主批近 8 次 schedule 全 skipped,现存 AI 行靠人工 dispatch 维持 |
