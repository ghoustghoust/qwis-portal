...
**统计**：底层文档 一致 8 · 待判 10 · 头部超前 0 · 缺头注 0　|　不要求头注 196 份　|　工作区未提交 3 份　|　总计 214 份
...
| ARCHITECTURE.md | 2026-09-23 | 待判 | `e468b3b` 2026-09-24 17:10 feat(H25 抬宽池读 2000→6000): 级3 的真天花板不是 cap 而是候选宽池读,单一取值收进 lib/prescreen<br>`b1e3f71` 2026-09-24 15:59 docs(级3 第一期生产读数到手·id=68): 两处原预估被证伪,新登记 H25<br>`2f34e61` 2026-09-24 15:12 docs(ARCHITECTURE §3 决策13): 候选层每源预配额——为什么限量再截断是免费的、宽池为何不许带 content_html、本地端为何不接（安全阀与策展策略不共用一个面） |
...
| docs/CLOUD_PIPELINE_GUIDE.md | 2026-09-23 | 待判 | `48af997` 2026-09-24 21:00 feat(夜间预算按峰值重排 + 两段耗时/尝试数落库 + 配额键可写): 用户裁定"时间长一点都可以,各边界留缓冲"<br>`e468b3b` 2026-09-24 17:10 feat(H25 抬宽池读 2000→6000): 级3 的真天花板不是 cap 而是候选宽池读,单一取值收进 lib/prescreen<br>`d2eefda` 2026-09-24 14:24 docs(步1 收口·四处读数更正): 交接文档快照 / ISSUES H19~H22 / 不变量20 / spec23 L4 作废标注 |
...
| docs/FEATURE_MATRIX.md | 2026-09-24 | 一致 | `7c47d93` 2026-09-24 22:01 feat(零额度初筛实验脚手架): 三臂留一法 + 分歧带清单,标注一回来就一条命令出结论<br>`b501b16` 2026-09-24 21:51 docs(H27·AI 早报自动触发未兑现): 晚间主批近 8 次 schedule 全 skipped,现存 AI 行靠人工 dispatch 维持<br>`e3162aa` 2026-09-24 21:29 docs(源侧细查底稿 + 自我推翻一条建议): 336 个不产出的源是四种不同的病;90天归档只占全库正文 7.8% |
...
| docs/ISSUES.md | 2026-09-23 | 待判 ⚠ | `b501b16` 2026-09-24 21:51 docs(H27·AI 早报自动触发未兑现): 晚间主批近 8 次 schedule 全 skipped,现存 AI 行靠人工 dispatch 维持<br>`e3162aa` 2026-09-24 21:29 docs(源侧细查底稿 + 自我推翻一条建议): 336 个不产出的源是四种不同的病;90天归档只占全库正文 7.8%<br>`48af997` 2026-09-24 21:00 feat(夜间预算按峰值重排 + 两段耗时/尝试数落库 + 配额键可写): 用户裁定"时间长一点都可以,各边界留缓冲" |
...
| docs/changes/2026-09-23-rss-pipeline-discussion-handoff.md | — | 不要求头注 | `48af997` 2026-09-24 21:00 feat(夜间预算按峰值重排 + 两段耗时/尝试数落库 + 配额键可写): 用户裁定"时间长一点都可以,各边界留缓冲"<br>`3ee95c9` 2026-09-24 18:47 docs(POST 副作用边界): 关键词版 id=69 未顶掉读者所见的 AI 版 id=68,代价只是历史多一行 |
...
| docs/eval/2026-09-24-prescreen-labels.md | — | 不要求头注 | `7c47d93` 2026-09-24 22:01 feat(零额度初筛实验脚手架): 三臂留一法 + 分歧带清单,标注一回来就一条命令出结论<br>`48af997` 2026-09-24 21:00 feat(夜间预算按峰值重排 + 两段耗时/尝试数落库 + 配额键可写): 用户裁定"时间长一点都可以,各边界留缓冲" |
| docs/eval/2026-09-24-prescreen-step1.md | 2026-09-24 | 不要求头注 ⚠ | `e2a4fc1` 2026-09-24 21:15 test(读层内联生成器执行锁 I1~I3): mock req/res 跑整个 catch-all handler,file: 临时库,零生产写<br>`48af997` 2026-09-24 21:00 feat(夜间预算按峰值重排 + 两段耗时/尝试数落库 + 配额键可写): 用户裁定"时间长一点都可以,各边界留缓冲" |
| docs/eval/2026-09-24-source-diagnosis.md | — | 不要求头注 ⚠ | `b501b16` 2026-09-24 21:51 docs(H27·AI 早报自动触发未兑现): 晚间主批近 8 次 schedule 全 skipped,现存 AI 行靠人工 dispatch 维持<br>`e3162aa` 2026-09-24 21:29 docs(源侧细查底稿 + 自我推翻一条建议): 336 个不产出的源是四种不同的病;90天归档只占全库正文 7.8% |
...
| docs/specs/44-prescreen-tier/spec.md | 2026-09-24 | 不要求头注 | `48af997` 2026-09-24 21:00 feat(夜间预算按峰值重排 + 两段耗时/尝试数落库 + 配额键可写): 用户裁定"时间长一点都可以,各边界留缓冲"<br>`6833df4` 2026-09-24 17:20 docs(H25 核销 + 读层生成器活体实测): 抬池后 id=69 覆盖 202→313,POST /api/daily-generate 200/33s/零模型调用 |
