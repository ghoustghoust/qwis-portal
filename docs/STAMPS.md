...
**统计**：底层文档 一致 7 · 待判 11 · 头部超前 0 · 缺头注 0　|　不要求头注 198 份　|　工作区未提交 1 份　|　总计 216 份
...
| docs/FEATURE_MATRIX.md | 2026-09-24 | 待判 | `3d937f7` 2026-09-25 05:08 feat(H32·主题全景接归因): stats.themePanorama={found,multi,named,drops}，判定一字未动；锁 T8/T10 上岗即抓到漏计的第 5 条静默出口<br>`a88c665` 2026-09-25 04:31 docs(第五轮复审核销): "8% 触发率"是无效分母，按点位算 AI 批 96% 在跑；导语第一条真归因恰恰是 ai_failed<br>`8623ede` 2026-09-25 03:44 fix(门禁红核销): 97da7a4 带着 doc-lint 1 错就推了 —— 表格单元里的裸 \|\| 把行撑成 6 格 |
...
| docs/ISSUES.md | 2026-09-23 | 待判 | `3d937f7` 2026-09-25 05:08 feat(H32·主题全景接归因): stats.themePanorama={found,multi,named,drops}，判定一字未动；锁 T8/T10 上岗即抓到漏计的第 5 条静默出口<br>`eb5df18` 2026-09-25 04:48 fix(CI 红核销): 撤掉"依赖本地文件"的门禁豁免；引用改成不指向文件，并给 doc-stamp 补竖线转义<br>`a88c665` 2026-09-25 04:31 docs(第五轮复审核销): "8% 触发率"是无效分母，按点位算 AI 批 96% 在跑；导语第一条真归因恰恰是 ai_failed |
...
| docs/eval/2026-09-24-turso-read-amp.md | — | 不要求头注 | `eb5df18` 2026-09-25 04:48 fix(CI 红核销): 撤掉"依赖本地文件"的门禁豁免；引用改成不指向文件，并给 doc-stamp 补竖线转义<br>`a88c665` 2026-09-25 04:31 docs(第五轮复审核销): "8% 触发率"是无效分母，按点位算 AI 批 96% 在跑；导语第一条真归因恰恰是 ai_failed |
