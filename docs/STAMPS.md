...
**统计**：底层文档 一致 7 · 待判 11 · 头部超前 0 · 缺头注 0　|　不要求头注 197 份　|　工作区未提交 2 份　|　总计 215 份
...
| docs/FEATURE_MATRIX.md | 2026-09-24 | 待判 ⚠ | `f59ce97` 2026-09-25 01:01 feat(H30·早报导语归因入库): theme 为空的三条出口从"静默 null"改成可区分的 stats.themeSkip<br>`47dd60a` 2026-09-25 00:25 docs(体积杠杆排序): 存量按轴复测 + 单篇分布 + gzip 实测 5.90× —— 压缩才是同量级最大的一刀<br>`05fd6b8` 2026-09-25 00:06 feat(三臂行为回测给出"是否采用"的数) + 独立审查推翻本轮 3 条说法后逐条改写 |
...
| docs/ISSUES.md | 2026-09-23 | 待判 ⚠ | `f59ce97` 2026-09-25 01:01 feat(H30·早报导语归因入库): theme 为空的三条出口从"静默 null"改成可区分的 stats.themeSkip<br>`47dd60a` 2026-09-25 00:25 docs(体积杠杆排序): 存量按轴复测 + 单篇分布 + gzip 实测 5.90× —— 压缩才是同量级最大的一刀<br>`05fd6b8` 2026-09-25 00:06 feat(三臂行为回测给出"是否采用"的数) + 独立审查推翻本轮 3 条说法后逐条改写 |
