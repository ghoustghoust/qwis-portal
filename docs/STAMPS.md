...
**统计**：底层文档 一致 9 · 待判 9 · 头部超前 0 · 缺头注 0　|　不要求头注 194 份　|　工作区未提交 1 份　|　总计 212 份
...
| docs/FEATURE_MATRIX.md | 2026-09-24 | 一致 | `f0affdb` 2026-09-24 15:00 docs(FEATURE_MATRIX 补级3能力行): §1.2 候选层每源预配额（四处部署面接线/本地端按裁定A不接/读数落 stats.prescreen）+ §1.5 头注与条数同步<br>`d2eefda` 2026-09-24 14:24 docs(步1 收口·四处读数更正): 交接文档快照 / ISSUES H19~H22 / 不变量20 / spec23 L4 作废标注<br>`1128d72` 2026-09-23 20:30 docs(交付链重订+B136+BL13 核销): ①AGENTS §3 用户重订——eval 各命令降级按需工具(自评卷+未稳立锁=门禁分不出世界变了与作弊),新链=npm test→push→ci+Actions→云端实测→冒烟→对抗审查→文档同步,锁纪律三条(diff 带 why/红了报用户三选一/不许自消);EVAL_GUIDE+FEATURE_MATRIX+CLOUD_PIPELINE 同步暂缓头注 ②ISSUES:B136 cron-job 8430047 死 PAT 连跪 09-20 起停用(全天 2 轮/370 源到期),BL13 核销出账,B121 复验改探针 ③FEATURE_MATRIX §1.5 测试 604→609+如实更正 0 红误记,push-CI 缺口核销 ④ARCHITECTURE §3.6 双保险暂按一档读 ⑤INDEX 登记 RSS 设计文档(1)与交接文档,交接文档补三个裁定与交付进展 ⑥STAMPS 刷新;lint:docs 0 错 2 警 EXIT=0 |
...
| docs/ISSUES.md | 2026-09-23 | 待判 ⚠ | `f81bd6e` 2026-09-24 14:58 docs(ISSUES H23 登记): runDaily 裸报告 candidates 是门槛后口径且从不写 gateDropped（破不变量12，非本轮引入，故意不在步1 修以免污染归因）<br>`d2eefda` 2026-09-24 14:24 docs(步1 收口·四处读数更正): 交接文档快照 / ISSUES H19~H22 / 不变量20 / spec23 L4 作废标注<br>`1483943` 2026-09-23 21:45 docs(B136 核销): PAT 已轮换,cron-job 8430047 换钥重启用,13:01/13:15/13:30Z 连续三轮 dispatch 成功,15min 心跳恢复;push-CI 同轮首绿(35868354059);STAMPS 刷新,lint:docs 0 错 |
...
| docs/eval/2026-09-24-prescreen-step1.md | 2026-09-24 | 不要求头注 | `6d1d21a` 2026-09-24 15:02 docs(取证补改前基线): 级3 上线前生产 7 行逐条落表——四期连排 truncated=true、id66 初筛失败 136/318=43%、id62/67 无 gateDropped 即 H23 现场<br>`f81bd6e` 2026-09-24 14:58 docs(ISSUES H23 登记): runDaily 裸报告 candidates 是门槛后口径且从不写 gateDropped（破不变量12，非本轮引入，故意不在步1 修以免污染归因） |
