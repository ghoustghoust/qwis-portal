...
| docs/eval/2026-09-24-prescreen-step1.md | 2026-09-24 | 不要求头注 ⚠ | `f81bd6e` 2026-09-24 14:58 docs(ISSUES H23 登记): runDaily 裸报告 candidates 是门槛后口径且从不写 gateDropped（破不变量12，非本轮引入，故意不在步1 修以免污染归因）<br>`c42979f` 2026-09-24 14:55 docs(取证补三行): 审查五条修复记录 / 冒烟在修复后重跑 / collect 最近 12 批 0 红 + 最新两提交部署 success |
