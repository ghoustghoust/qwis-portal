...
| docs/FEATURE_MATRIX.md | 2026-09-24 | 待判 | `683650f` 2026-09-25 06:02 docs(FEATURE_MATRIX 同步): §1.5 条数 643→644、H32 行补 rated、新立 H35 行、表头改到第六轮收口<br>`3d937f7` 2026-09-25 05:08 feat(H32·主题全景接归因): stats.themePanorama={found,multi,named,drops}，判定一字未动；锁 T8/T10 上岗即抓到漏计的第 5 条静默出口<br>`a88c665` 2026-09-25 04:31 docs(第五轮复审核销): "8% 触发率"是无效分母，按点位算 AI 批 96% 在跑；导语第一条真归因恰恰是 ai_failed |
...
| docs/ISSUES.md | 2026-09-23 | 待判 | `97bbc66` 2026-09-25 05:58 fix(第六轮审查核销·H35 登记): 两把我自己的锁各有一处假信号，另有生产台账第一份<br>`3d937f7` 2026-09-25 05:08 feat(H32·主题全景接归因): stats.themePanorama={found,multi,named,drops}，判定一字未动；锁 T8/T10 上岗即抓到漏计的第 5 条静默出口<br>`eb5df18` 2026-09-25 04:48 fix(CI 红核销): 撤掉"依赖本地文件"的门禁豁免；引用改成不指向文件，并给 doc-stamp 补竖线转义 |
...
| docs/changes/2026-09-23-rss-pipeline-discussion-handoff.md | — | 不要求头注 | `97bbc66` 2026-09-25 05:58 fix(第六轮审查核销·H35 登记): 两把我自己的锁各有一处假信号，另有生产台账第一份<br>`0c302ef` 2026-09-25 05:10 docs(H32 交付记录): 主题全景归因那一轮写进变更档，并补 P12 的 F2P 实证（把契约键改名→P12 红，P11 仍绿） |
...
| docs/eval/2026-09-24-turso-read-amp.md | — | 不要求头注 | `97bbc66` 2026-09-25 05:58 fix(第六轮审查核销·H35 登记): 两把我自己的锁各有一处假信号，另有生产台账第一份<br>`eb5df18` 2026-09-25 04:48 fix(CI 红核销): 撤掉"依赖本地文件"的门禁豁免；引用改成不指向文件，并给 doc-stamp 补竖线转义 |
