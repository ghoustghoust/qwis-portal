...
**统计**：底层文档 一致 6 · 待判 10 · 头部超前 2 · 缺头注 0　|　不要求头注 235 份　|　工作区未提交 19 份　|　总计 253 份
...
| docs/pitfalls/backend.md | — | 不要求头注 | `4e5441c` 2026-09-21 06:53 fix(B112 判据)+test(Q4)+坑#70 补充: 档位类型判据别用带回溯的负向 lookahead<br>`467d10c` 2026-09-21 06:43 fix(B112)+test(Q1~Q5)+坑#70: 日报档位字段写入侧统一为整数常量，判据并进 W14 |
