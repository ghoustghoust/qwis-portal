...
**统计**：底层文档 一致 7 · 待判 9 · 头部超前 2 · 缺头注 0　|　不要求头注 235 份　|　工作区未提交 13 份　|　总计 253 份
...
| docs/DOC_GOVERNANCE.md | 2026-09-20 | 待判 | `2dd6808` 2026-09-21 03:03 feat(门禁扩面)+test(L1~L4): doc-lint 加 5 条判据并给它做双向自证 —— 编号撞号那条是本轮自己咬出来的<br>`29c821f` 2026-09-20 17:58 docs(§4.1 精炼落地): 46 行长文压成"问题+定性+去处"，原文逐字照档且可反查<br>`c183413` 2026-09-20 17:00 docs(§4.1 补全定义): 洁净=精炼+去冗+归档；INDEX 登记两份新归档件（只提交我自己的 hunk） |
| docs/EVAL_GUIDE.md | 2026-09-19 | 待判 | `2dd6808` 2026-09-21 03:03 feat(门禁扩面)+test(L1~L4): doc-lint 加 5 条判据并给它做双向自证 —— 编号撞号那条是本轮自己咬出来的<br>`e49c54d` 2026-09-21 02:28 test(B117)+feat(W23): 测试侧写方法必须指隔离库 —— 两份打生产的写用例搬进本地 libsql 文件库<br>`5695874` 2026-09-20 23:08 fix(#65 之后第 3 条)+test(B102): 删除/保留谓词收进 lib/retention.js 一份，本地不再删内容 |
| docs/FEATURE_MATRIX.md | 2026-09-20 | 待判 ⚠ | `2dd6808` 2026-09-21 03:03 feat(门禁扩面)+test(L1~L4): doc-lint 加 5 条判据并给它做双向自证 —— 编号撞号那条是本轮自己咬出来的<br>`e49c54d` 2026-09-21 02:28 test(B117)+feat(W23): 测试侧写方法必须指隔离库 —— 两份打生产的写用例搬进本地 libsql 文件库<br>`138b1c7` 2026-09-21 01:53 feat(B103/D3)+test(D1~D10): 内容级转储与删除前置闸 —— 云端第一次有"回得来"的底牌 |
...
| docs/ISSUES.md | 2026-09-21 | 一致 | `2dd6808` 2026-09-21 03:03 feat(门禁扩面)+test(L1~L4): doc-lint 加 5 条判据并给它做双向自证 —— 编号撞号那条是本轮自己咬出来的<br>`e49c54d` 2026-09-21 02:28 test(B117)+feat(W23): 测试侧写方法必须指隔离库 —— 两份打生产的写用例搬进本地 libsql 文件库<br>`16a957d` 2026-09-21 01:56 docs(B101 拦一下)+docs(BL10 复核): 待删量按现役库重算是 50,636 条（84.6%），不是旧库那 10,733 |
...
| docs/archive/debugging/2026-09-21-release-approval-ledger.md | — | 不要求头注 | `2dd6808` 2026-09-21 03:03 feat(门禁扩面)+test(L1~L4): doc-lint 加 5 条判据并给它做双向自证 —— 编号撞号那条是本轮自己咬出来的<br>`138b1c7` 2026-09-21 01:53 feat(B103/D3)+test(D1~D10): 内容级转储与删除前置闸 —— 云端第一次有"回得来"的底牌 |
