...
**统计**：底层文档 一致 8 · 待判 8 · 头部超前 2 · 缺头注 0　|　不要求头注 234 份　|　工作区未提交 14 份　|　总计 252 份
...
| docs/FEATURE_MATRIX.md | 2026-09-20 | 待判 | `138b1c7` 2026-09-21 01:53 feat(B103/D3)+test(D1~D10): 内容级转储与删除前置闸 —— 云端第一次有"回得来"的底牌<br>`5695874` 2026-09-20 23:08 fix(#65 之后第 3 条)+test(B102): 删除/保留谓词收进 lib/retention.js 一份，本地不再删内容<br>`6e0c5c6` 2026-09-20 22:02 fix(eval)+test(#65): B106 收口 —— 取证工具不再把"没跑到"判成"锁假了"，清单参数不再静默截断 |
...
| docs/ISSUES.md | 2026-09-21 | 一致 ⚠ | `138b1c7` 2026-09-21 01:53 feat(B103/D3)+test(D1~D10): 内容级转储与删除前置闸 —— 云端第一次有"回得来"的底牌<br>`2e3de79` 2026-09-21 00:23 fix(weekly)+test(B121): 周刊骨架缺失如实进状态，期号按内容窗口定，杂志层退避重试一次<br>`4608b3a` 2026-09-20 23:40 docs(换库后遗症 B119①): 日报候选池放开并落一手对账 —— 26h 窗口 82 条/9 源 → 1,939 条/308 源 |
...
| docs/archive/debugging/2026-09-21-release-approval-ledger.md | — | 不要求头注 | `138b1c7` 2026-09-21 01:53 feat(B103/D3)+test(D1~D10): 内容级转储与删除前置闸 —— 云端第一次有"回得来"的底牌 |
...
| docs/eval/bl10-null-audit-20260921.md | — | 不要求头注 ⚠ | `138b1c7` 2026-09-21 01:53 feat(B103/D3)+test(D1~D10): 内容级转储与删除前置闸 —— 云端第一次有"回得来"的底牌 |
...
| docs/specs/43-collect-retention-safety/spec.md | — | 不要求头注 ⚠ | `138b1c7` 2026-09-21 01:53 feat(B103/D3)+test(D1~D10): 内容级转储与删除前置闸 —— 云端第一次有"回得来"的底牌<br>`4205170` 2026-09-20 08:09 docs(第6轮只读复核): 测试侧写入面全量清点——生产数据从未被测试写过，但 3 份仍绑生产（B117） |
