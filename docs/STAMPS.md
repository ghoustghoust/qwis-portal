...
| docs/ISSUES.md | 2026-09-21 | 一致 ⚠ | `4a52576` 2026-09-21 06:22 docs(B109 验收入账): 线上 /api/alerts/config 读数 + F2P 证据（V1~V7 改前红 7/7）<br>`6c9a2c7` 2026-09-21 06:20 feat(B109/B45)+test(V1~V7)+feat(W19): 报警事件表收成 lib/alert-events.js 一份，云端后台四个假开关拔掉<br>`b42e6f1` 2026-09-21 05:46 docs(B107 验收轮入账): 两轮 e2e 读数 + 「含热榜」浏览器层证据（只提交 JSON，截图不入库） |
