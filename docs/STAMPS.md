...
| docs/FEATURE_MATRIX.md | 2026-09-24 | 待判 | `3b6f15e` 2026-09-25 03:11 test(第四轮复审核销): 提取器不再把注释/字符串里的 report 当返回点，I4 扩到五臂并诚实写下 consistent 的效力边界<br>`fdf1fa0` 2026-09-25 02:38 docs(FEATURE_MATRIX): §1.5 条数 637→640 与 H31/H30 口径同步（单一写死处不许滞后）<br>`67a8b7a` 2026-09-25 01:18 docs(边界总表): Actions/Turso/AI 三侧的官方上限与本仓余量对账，并据此把 H27 的机制读法写完 |
...
| docs/ISSUES.md | 2026-09-23 | 待判 | `3b6f15e` 2026-09-25 03:11 test(第四轮复审核销): 提取器不再把注释/字符串里的 report 当返回点，I4 扩到五臂并诚实写下 consistent 的效力边界<br>`68e7ec3` 2026-09-25 02:36 docs(H31 收口 + 交付链证据回填): /api/articles 的 limit 是"参数不存在"而非失效；本轮 CI/云端/冒烟/审查四步留证<br>`b104bed` 2026-09-25 02:28 fix(读层同形补到第 5 处 + 判据换成括号配平): 形态锁与执行锁各管一半，谁也别替谁背书（第三轮审查） |
...
| docs/eval/2026-09-24-boundaries.md | — | 不要求头注 | `67a8b7a` 2026-09-25 01:18 docs(边界总表): Actions/Turso/AI 三侧的官方上限与本仓余量对账，并据此把 H27 的机制读法写完 |
