...
**统计**：底层文档 一致 7 · 待判 9 · 头部超前 2 · 缺头注 0　|　不要求头注 235 份　|　工作区未提交 15 份　|　总计 253 份
...
| docs/FEATURE_MATRIX.md | 2026-09-20 | 待判 ⚠ | `fdce0f1` 2026-09-21 03:06 docs(§1.5 条数自洽): 483→487 的来路补一句，别让同一格里两个汇总行互相打脸<br>`2dd6808` 2026-09-21 03:03 feat(门禁扩面)+test(L1~L4): doc-lint 加 5 条判据并给它做双向自证 —— 编号撞号那条是本轮自己咬出来的<br>`e49c54d` 2026-09-21 02:28 test(B117)+feat(W23): 测试侧写方法必须指隔离库 —— 两份打生产的写用例搬进本地 libsql 文件库 |
