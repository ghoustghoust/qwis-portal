...
| docs/eval/2026-09-24-prescreen-step1.md | 2026-09-24 | 不要求头注 ⚠ | `c42979f` 2026-09-24 14:55 docs(取证补三行): 审查五条修复记录 / 冒烟在修复后重跑 / collect 最近 12 批 0 红 + 最新两提交部署 success<br>`93786ba` 2026-09-24 14:32 docs(取证·级3 改前真值与交付证据): docs/eval/2026-09-24-prescreen-step1.md（AGENTS §3 第7条） |
